...
.Repositories
image::images/repositories.png["Repositories", width="600", link="images/repositories.png"]

The list updates as you type in the search bar.

.Search Repositories
image::images/repositories_search.png["Search Repositories", width="600", link="images/repositories_search.png"]
